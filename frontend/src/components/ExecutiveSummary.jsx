    ...
    return (
        <div className="bg-white rounded-xl shadow p-8 max-w-4xl mx-auto print:shadow-none print:p-0">
            <div className="flex justify-between items-start border-b-2 border-emerald-900 pb-6 mb-8">
                ...
                <button
                    onClick={handlePrint}
                    className="print:hidden flex items-center gap-2 bg-emerald-100 text-emerald-900 px-4 py-2 rounded-lg hover:bg-emerald-200 transition-colors"
                >
            ...
            <div className="space-y-8 text-gray-800 leading-relaxed">
                ...
                <section>
                    <h3 className="text-lg font-bold text-emerald-900 mb-3 border-l-4 border-emerald-500 pl-3">PROBLEM STATEMENT</h3>
                ...
                <section>
                    <h3 className="text-lg font-bold text-emerald-900 mb-3 border-l-4 border-emerald-500 pl-3">KEY FINDINGS</h3>
                    <ol className="list-decimal pl-5 space-y-4">
                        <li>
                            <strong>Branch Segmentation:</strong> Your 25 branches group into distinct operational profiles based on revenue vs. profit margin variance. This reveals that uniform menu pricing leaves money on the table in premium or highly seasonal locations. <em>Note: The AI automatically clipped theoretical negative margins exceeding -20% (e.g., Amioun, Saida) to prevent severe anomalies from skewing the K-Means centroids.</em>
                        </li>
                        <li>
                ...
                <section>
                    <h3 className="text-lg font-bold text-emerald-900 mb-3 border-l-4 border-emerald-500 pl-3">RECOMMENDATIONS</h3>
                ...
                <section>
                    <h3 className="text-lg font-bold text-emerald-900 mb-3 border-l-4 border-emerald-500 pl-3">METHODOLOGY</h3>
